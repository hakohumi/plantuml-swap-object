...
import { parse_arrow, parse_line } from '../parse_ObjectRelationSentence'
...
suite('split_arrow_line Test Suite', () => {
  test('split_arrow_line Test', () => {
    const test_patterns: {
      input: string
      expect: {
        left_line: string
    ...
    test_patterns.forEach(({ input, expect }) => {
      const actual = parse_arrow(input)
      assert.deepEqual(actual, expect)
    })
  })
})

suite('split_line Test Suite', () => {
  test('split_line Test', () => {
    const test_patterns: {
      input: string
      expect: {
        left_line: string
